...
Last Changed: 2/16/2017 12:17:55 PM
...
function LuckyCharms.OnCharmClick(mouseButton,self)
	...
	elseif(mouseButton == 'RightButton') then
		if (IsShiftKeyDown()) then
			...
			if(charmNum == 1) then
				CC1DD = CreateFrame("Frame", "CC1DD", LuckyCharm1, "UIDropDownMenuTemplate"); 
			...
			elseif(charmNum == 2) then
				CC2DD = CreateFrame("Frame", "CC2DD", LuckyCharm2, "UIDropDownMenuTemplate"); 
			...
			elseif(charmNum == 3) then
				CC3DD = CreateFrame("Frame", "CC3DD", LuckyCharm3, "UIDropDownMenuTemplate"); 
			...
			elseif(charmNum == 4) then
				CC4DD = CreateFrame("Frame", "CC4DD", LuckyCharm4, "UIDropDownMenuTemplate"); 
			...
			elseif(charmNum == 5) then
				CC5DD = CreateFrame("Frame", "CC5DD", LuckyCharm5, "UIDropDownMenuTemplate"); 
			...
			elseif(charmNum == 6) then
				CC6DD = CreateFrame("Frame", "CC6DD", LuckyCharm6, "UIDropDownMenuTemplate"); 
			...
			elseif(charmNum == 7) then
				CC7DD = CreateFrame("Frame", "CC7DD", LuckyCharm7, "UIDropDownMenuTemplate"); 
			...
			elseif(charmNum == 8) then
				CC8DD = CreateFrame("Frame", "CC8DD", LuckyCharm8, "UIDropDownMenuTemplate"); 
  ...
  if (level == 1) then
   ...
   if (level == 3) then
     ...
     for key, subsubarray in pairs(subarray) do
       ...
       info.func = function() LuckyCharms.CCDD_OnClick(self,arg1) end;
       info.value = arg1;
       --Tooltips
...
function LuckyCharms.ClearCCAssignments(ccCharm)
	if(ccCharm == nil) then
		...
		for i=1, 8 do
				LC2_Settings[LC2Profile].charmcc[i] = { ["name"] = ""; ["icon"] = ""; ["ccid"] = ""; ["spellid"] = ""; };
...
function LuckyCharms.CCButtonTips(button)
	if(LC2_Settings[LC2Profile].tooltips == 1) then
		...
		if(button == "LCKillOrder_C1")then
			...
			GameTooltip:SetSpellByID(LC2_Settings[LC2Profile].charmcc[1]["spellid"]);
			GameTooltip:AppendText(" - " ..LC2_Settings[LC2Profile].charmcc[1]["name"]);
		elseif(button == "LCKillOrder_C2")then
			GameTooltip:SetOwner(LCKillOrder_C2, "ANCHOR_RIGHT");
			GameTooltip:SetSpellByID(LC2_Settings[LC2Profile].charmcc[2]["spellid"]);
			GameTooltip:AppendText(" - " ..LC2_Settings[LC2Profile].charmcc[2]["name"]);
		elseif(button == "LCKillOrder_C3")then
			GameTooltip:SetOwner(LCKillOrder_C3, "ANCHOR_RIGHT");
			GameTooltip:SetSpellByID(LC2_Settings[LC2Profile].charmcc[3]["spellid"]);
			GameTooltip:AppendText(" - " ..LC2_Settings[LC2Profile].charmcc[3]["name"]);
		elseif(button == "LCKillOrder_C4")then
			GameTooltip:SetOwner(LCKillOrder_C4, "ANCHOR_RIGHT");
			GameTooltip:SetSpellByID(LC2_Settings[LC2Profile].charmcc[4]["spellid"]);
			GameTooltip:AppendText(" - " ..LC2_Settings[LC2Profile].charmcc[4]["name"]);
		elseif(button == "LCKillOrder_C5")then
			GameTooltip:SetOwner(LCKillOrder_C5, "ANCHOR_RIGHT");
			GameTooltip:SetSpellByID(LC2_Settings[LC2Profile].charmcc[5]["spellid"]);
			GameTooltip:AppendText(" - " ..LC2_Settings[LC2Profile].charmcc[5]["name"]);
		elseif(button == "LCKillOrder_C6")then
			GameTooltip:SetOwner(LCKillOrder_C6, "ANCHOR_RIGHT");
			GameTooltip:SetSpellByID(LC2_Settings[LC2Profile].charmcc[6]["spellid"]);
			GameTooltip:AppendText(" - " ..LC2_Settings[LC2Profile].charmcc[6]["name"]);
		elseif(button == "LCKillOrder_C7")then
			GameTooltip:SetOwner(LCKillOrder_C7, "ANCHOR_RIGHT");
			GameTooltip:SetSpellByID(LC2_Settings[LC2Profile].charmcc[7]["spellid"]);
			GameTooltip:AppendText(" - " ..LC2_Settings[LC2Profile].charmcc[7]["name"]);
		elseif(button == "LCKillOrder_C8")then
			GameTooltip:SetOwner(LCKillOrder_C8, "ANCHOR_RIGHT");
			GameTooltip:SetSpellByID(LC2_Settings[LC2Profile].charmcc[8]["spellid"]);
			GameTooltip:AppendText(" - " ..LC2_Settings[LC2Profile].charmcc[8]["name"]);
		end
		GameTooltip:Show();
	end --if tooltips == 1
end
...
function LuckyCharms.KOCTextPos(new_pos)
	...
	if(new_pos == "top") then
		for i=1,8 do
			if(_G["LuckyCharm"..i]) then
				_G["LCKillOrder_C"..i]:SetPoint("BOTTOM","LuckyCharm"..i,"TOP",0,4);
	...
	elseif(new_pos == "bottom") then
		for i=1,8 do
			if(_G["LuckyCharm"..i]) then
				_G["LCKillOrder_C"..i]:SetPoint("TOP","LuckyCharm"..i,"BOTTOM",0,-4);
				if(_G["LuckyCharm"..i]:IsVisible())then
					_G["LCKillOrder_C"..i]:Show();
				end
			end
	...
	elseif(new_pos == "left") then
		for i=1,8 do
			if(_G["LuckyCharm"..i]) then
				_G["LCKillOrder_C"..i]:SetPoint("RIGHT","LuckyCharm"..i,"LEFT",-4,0);
				if(_G["LuckyCharm"..i]:IsVisible())then
					_G["LCKillOrder_C"..i]:Show();
				end
			end
	...
	elseif(new_pos == "right") then
		for i=1,8 do
			if(_G["LuckyCharm"..i]) then
				_G["LCKillOrder_C"..i]:SetPoint("LEFT","LuckyCharm"..i,"RIGHT",4,0);
				if(_G["LuckyCharm"..i]:IsVisible())then
					_G["LCKillOrder_C"..i]:Show();
				end
			end
...
function LuckyCharms.DrawCharms()
	...
	if (bpos == "left" or bpos == "right") then
		...
		if(LC2_Settings[LC2Profile].koctp == "left" or LC2_Settings[LC2Profile].koctp == "right") then
	...
	elseif (bpos == "top" or bpos == "bottom") then
		...
		if(LC2_Settings[LC2Profile].koctp == "top" or LC2_Settings[LC2Profile].koctp == "bottom") then
			LuckyCharms.Config.KORadioPos("right",0);
		else
			LuckyCharms.Config.KOAnchor(LC2_Settings[LC2Profile].koctp);
		end
		LuckyCharmConfigKODisplayPosDefault:SetText(CHAT_DEFAULT..": |cFF4DBD33"..LC2TXT_RIGHT.."|r");
	end
...
function LuckyCharms.PrntChatMsg()
		...
		if(LC2_Settings[LC2Profile].charmStatus[n] == 1) then
			if(LC2_Settings[LC2Profile].komode == "icons") then
				...
				if(string.len(LC2_Settings[LC2Profile].charmcc[n]["name"]) > 0) then
					ccOrder = ccOrder .. charmArr[n][1].." - "..LC2_Settings[LC2Profile].charmcc[n]["name"].." "..GetSpellLink(LC2_Settings[LC2Profile].charmcc[n]["spellid"])..", ";
				end
			else
				order = order .. charmArr[n][0] .. ", ";
				if(string.len(LC2_Settings[LC2Profile].charmcc[n]["name"]) > 0) then
					ccOrder = ccOrder .. charmArr[n][0].." - "..LC2_Settings[LC2Profile].charmcc[n]["name"].." "..GetSpellLink(LC2_Settings[LC2Profile].charmcc[n]["spellid"])..", ";
				end
			end
		end
	end
	if(LC2_Settings[LC2Profile].kopr == 1) then
		...
		if(UnitInRaid("player") and LC2_Settings[LC2Profile].korw == 0) then
			if(UnitIsGroupAssistant("player") or UnitIsGroupLeader("player")) then
				if(LC2_Settings[LC2Profile].koprint==1)then
					SendChatMessage("[LC2] "..LC2TXT_KILLORDER..": " .. order,"RAID");
				end
				if(LC2_Settings[LC2Profile].kocc==1) then
					for i=1, 8 do
						...
						if(LC2_Settings[LC2Profile].charmStatus[n] == 1) then
							if(LC2_Settings[LC2Profile].komode == "icons") then
								if(string.len(LC2_Settings[LC2Profile].charmcc[n]["name"]) > 0) then
									SendChatMessage("[LC2] "..LC2TXT_CCABBRV..": " .. charmArr[n][1].." - "..LC2_Settings[LC2Profile].charmcc[n]["name"].." "..GetSpellLink(LC2_Settings[LC2Profile].charmcc[n]["spellid"]),"RAID");
								end
							else
								if(string.len(LC2_Settings[LC2Profile].charmcc[n]["name"]) > 0) then
									SendChatMessage("[LC2] "..LC2TXT_CCABBRV..": " .. charmArr[n][0].." - "..LC2_Settings[LC2Profile].charmcc[n]["name"].." "..GetSpellLink(LC2_Settings[LC2Profile].charmcc[n]["spellid"]),"RAID");
								end
							end
						end
					end--for i,8
		...
		elseif(GetNumGroupMembers() > 0 and UnitInRaid("player")==nil) then
			...
			--if(UnitIsPartyLeader("player") == 1) then
				if(LC2_Settings[LC2Profile].koprint==1)then
					SendChatMessage("[LC2] "..LC2TXT_KILLORDER..": " .. order,"PARTY");
				end
				if(LC2_Settings[LC2Profile].kocc==1) then
					for i=1, 8 do
						local n = LC2_Settings[LC2Profile].korder[i];
						if(LC2_Settings[LC2Profile].charmStatus[n] == 1) then
							if(LC2_Settings[LC2Profile].komode == "icons") then
								if(string.len(LC2_Settings[LC2Profile].charmcc[n]["name"]) > 0) then
									SendChatMessage("[LC2] "..LC2TXT_CCABBRV..": " .. charmArr[n][1].." - "..LC2_Settings[LC2Profile].charmcc[n]["name"].." "..GetSpellLink(LC2_Settings[LC2Profile].charmcc[n]["spellid"]),"PARTY");
								end
							else
								if(string.len(LC2_Settings[LC2Profile].charmcc[n]["name"]) > 0) then
									SendChatMessage("[LC2] "..LC2TXT_CCABBRV..": " .. charmArr[n][0].." - "..LC2_Settings[LC2Profile].charmcc[n]["name"].." "..GetSpellLink(LC2_Settings[LC2Profile].charmcc[n]["spellid"]),"PARTY");
								end
							end
						end
					end--for i,8
	...
	if(LC2_Settings[LC2Profile].korw == 1) then
		...
		if(UnitInRaid("player")) then
			if(UnitIsGroupAssistant("player") or UnitIsGroupLeader("player")) then
				if(LC2_Settings[LC2Profile].koprint==1)then
					SendChatMessage("[LC2] "..LC2TXT_KILLORDER..": " .. order,"RAID_WARNING");
				end
				if(LC2_Settings[LC2Profile].kocc==1 and string.len(ccOrder) > 0) then
					SendChatMessage("[LC2] "..LC2TXT_CCABBRV..": " .. ccOrder,"RAID_WARNING");
				end
			else
