...
function BFLC2:PLAYER_ENTERING_WORLD()
	...
	LBF:Group(LC2NAME, "Crowd Control Buttons"):AddButton(_G["LCKillOrder_C1"]);
	LBF:Group(LC2NAME, "Crowd Control Buttons"):AddButton(_G["LCKillOrder_C2"]);
	LBF:Group(LC2NAME, "Crowd Control Buttons"):AddButton(_G["LCKillOrder_C3"]);
	LBF:Group(LC2NAME, "Crowd Control Buttons"):AddButton(_G["LCKillOrder_C4"]);
	LBF:Group(LC2NAME, "Crowd Control Buttons"):AddButton(_G["LCKillOrder_C5"]);
	LBF:Group(LC2NAME, "Crowd Control Buttons"):AddButton(_G["LCKillOrder_C6"]);
	LBF:Group(LC2NAME, "Crowd Control Buttons"):AddButton(_G["LCKillOrder_C7"]);
	LBF:Group(LC2NAME, "Crowd Control Buttons"):AddButton(_G["LCKillOrder_C8"]);
	
	LBF:Group(LC2NAME, "World Marker Buttons"):AddButton(_G["LuckyCharm2Flare1"]);
	LBF:Group(LC2NAME, "World Marker Buttons"):AddButton(_G["LuckyCharm2Flare2"]);
	LBF:Group(LC2NAME, "World Marker Buttons"):AddButton(_G["LuckyCharm2Flare3"]);
	LBF:Group(LC2NAME, "World Marker Buttons"):AddButton(_G["LuckyCharm2Flare4"]);
	LBF:Group(LC2NAME, "World Marker Buttons"):AddButton(_G["LuckyCharm2Flare5"]);
	LBF:Group(LC2NAME, "World Marker Buttons"):AddButton(_G["LuckyCharm2Flare6"]);
	LBF:Group(LC2NAME, "World Marker Buttons"):AddButton(_G["LuckyCharm2Flare7"]);
	LBF:Group(LC2NAME, "World Marker Buttons"):AddButton(_G["LuckyCharm2Flare8"]);
	LBF:Group(LC2NAME, "World Marker Buttons"):AddButton(_G["LuckyCharm2Flare9"]);
